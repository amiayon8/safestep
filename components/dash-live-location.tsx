...
import { IconMapPin, IconArrowsDiagonal } from "@tabler/icons-react";
...
export default function DashLiveLocation() {
                ...
                <div className="flex flex-row justify-between items-center">
                    <div className="flex flex-row justify-start items-center gap-2">
                        <span className="bg-primary p-1 rounded-full aspect-square text-primary-foreground">
                            <IconMapPin className="stroke-[2.5] size-4" />
                        </span>
                        <span className="font-medium text-lg">Live Location</span>
                    </div>
